...
The first represents a species that is univoltine and has a fairly narrow flight length (Mean 200, 10 SD).
...
The next represents a species with a longer flight length (Mean 200, 20 SD).
...
And the third would more likely be a species that flies year long with overlapping broods but has one peak in density (Mean 200, 40 SD). 
